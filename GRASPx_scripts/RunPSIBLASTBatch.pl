...
foreach(<$q_dir/$q_label_prefix*.fa>){
    ...
    system "/usr/local/packages/ncbi-blast+-2.2.28/bin/psiblast -query $_ -db $db -evalue 1000 -num_threads 8 -outfmt 7 -num_iterations 3 -max_target_seqs 20000000 >$out_dir/$file_stem.frag.psibst";
}
