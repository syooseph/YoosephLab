...
namespace args 
{
	...
	const std::string USAGE_POST_STAT = 
		"Usage: poststat [options] inputs\n"
		" e.g.: poststat -o spa.fasta -p post.fasta -r spa.place.bin\n";
    ...
    void parse_cmd_args_poststat( int argc, 
								  char ** argv, 
								  size_t      &num_read,
								  size_t      &min_length,
								  //std::string &orig_faa,
